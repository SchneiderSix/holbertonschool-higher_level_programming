...
class TestSquare(unittest.TestCase):
    ...
    def test_arearect_str_dic(self):
        ...
        self.assertEqual(self.r1.__str__(), '[Square] (25) 2/0 - 1')
        self.assertEqual(self.r1.to_dictionary(), {'id': 25, 'x': 2, 'size': 1, 'y': 0})
    ...
    def test_savetofilerec(self):
        ...
        with open("Square.json") as fp3:
            self.assertEqual(fp3.read(), '[{"id": 31, "x": 2, "size": 1, "y": 0}]')
